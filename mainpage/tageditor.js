...
class TagEditor extends React.Component {
  constructor(props) {
    ...
    this.editTagElements = []; //this.firstMount;* if first mount has happened
  ...
  saveTagDescriptions() {
    ...
    chrome.storage.local.set({
      tagDescriptions: this.state.tagData
    });
  ...
  render() {
    return React.createElement("div", {
      ...
      return [React.createElement("div", {
        ...
        key: 0
      }, reses[0]), React.createElement("div", {
        className: "edit-section",
        key: 1
      }, reses[1])];
    })()));
